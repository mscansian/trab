...
\begin{center}
{
	...
	Professor: Fermando Humel Lafratta \\
...
\begin{center}
{
	...
	[Inserir aqui a ficha de avaliação pela universidade]
}
\pagebreak

\begin{center}
{
	[Inserir aqui a ficha de avaliação pela empresa]
}
\pagebreak

\begin{center}
{
	[Inserir aqui o plano de estágio]
}
\pagebreak
...
%MOZI, LEMBRE-SE QUE A REFERÊNCIA NÃO É JUSTIFICADA, MAS SIM ALINHADA À DIREITA. NADA NESSA FOLHA DEVE TER PARÁGRAFO.
...
%OS PREÇOS SÃO "MAIS BEM" CALCULADOS. O "MELHOR" VEM EM SUBSTITUIÇÃO AO "MAIS BOM", MAS O "MAIS BEM", NESSE CASO, MANTEM-SE. O "MAIS BEM" É SUBSTITUÍDO POR "MELHOR" QUANTO FAZ-SE UMA COMPARAÇÃO, POR EXEMPLO: VOCÊ COZINHA MELHOR QUE EU (E NÃO MAIS BEM). MOZI GRAMMAR NAZI :p
